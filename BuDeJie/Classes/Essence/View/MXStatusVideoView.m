...
@implementation MXStatusVideoView
...
- (void)setStatus:(MXStatusItem *)status{
    ...
    self.videoLengthLabel.text = [NSString stringWithFormat:@"%02zd : %02zd",status.videotime / 60, status.videotime % 60];
    //根据网络状态加载图片
